...
module.exports = () => {
    ...
    Order.hasMany(Payment, {as: 'payment', foreignKey: {name: 'id', allowNull: false}, constraints: true, onDelete: 'CASCADE'});
    Payment.belongsTo(Order, {as: 'payment', foreignKey: {name: 'id', allowNull: false} } );
    ...
    Product.belongsTo(ProductList, {as: 'productlist', foreignKey: {name: 'Product_id', allowNull: false, } });
